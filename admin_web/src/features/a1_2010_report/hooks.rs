...
use loquat_common::{models::{FanSize, A1Standard2010Report, FanSeries, A1Standard2010Determination}, api::a1_2010_report::UpdateBody};
use web_sys::MouseEvent;
use yew::{Callback, UseStateHandle, hook, use_state, use_callback, use_memo, use_effect_with_deps};
use yewdux::prelude::use_store;

use crate::api::store::Store as ApiStore;
use crate::api::store::{ApiRequestAction, GetParameters, Gettable};
use crate::store::{use_app_store_selector_with_deps, select_a1_report};
          ...
          |_evt: MouseEvent, (dispatch, parsed_update_body_ref)| {
              if let Some(update_body) = (*parsed_update_body_ref).as_ref() {
                  dispatch.apply(ApiRequestAction::Get(
                      ...
                      Gettable::PutA12010Report { body: update_body.clone() },
                  ))
              }
          },
