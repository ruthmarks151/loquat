...
use loquat_common::models::{FanSize, FanSeries};
use yew::{Html, Properties, function_component, html, UseStateHandle, use_callback, use_effect_with_deps};

use crate::features::{fan_size::FanSizePicker, fan_series::FanSeriesPicker};
...
#[function_component]
pub fn FanSeriesAndSizePicker(FanSeriesAndSizePickerProps { saved_size, picked_fan_series_state, picked_fan_size_state }: &FanSeriesAndSizePickerProps) -> Html {
