        ...
        if let Ok(curve) = op_res {
            ...
            assert_eq!(
                curve
                    ...
                    .collect::<Vec<_>>(),
                vec![1.3396383203908824, 1.3859463879155183, 1.3834084782728928, 1.3701813159900245, 1.3488854531577197, 1.3697163992115997, 1.484445786771368, 1.3207762123571183]
            );
        } else {
            assert!(op_res.is_ok());
        }
